/*
  FLEXSWITCH – GLOBAL SCRIPTS (app.js)
  ------------------------------------
  Scope: Shared behaviors for ALL pages in the Flexswitch site.
  Tech: Vanilla JS (no frameworks). Modular, defensive, and accessible.

  What this file provides:
  1) Cart state (localStorage) + accessible cart drawer UI
  2) Add‑to‑cart handlers (buttons with [data-add-to-cart])
  3) Product quick‑view modal on products.html (buttons with [data-open])
  4) Small conveniences (current year injection, simple helpers)

  How to use:
  - Include on every page, ideally at the end of <body>.
    <script src="app.js" defer></script>

  IMPORTANT: This script is defensive. If a given page doesn’t have an element
  (e.g., no cart drawer on a minimal page), it won’t error — it simply skips.
*/
